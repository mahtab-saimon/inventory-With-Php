...
if (isset($_REQUEST['catId'])){
    $id = $_REQUEST['catId'];
    $delCategory = $cat->delCatById($id);
}
?>
<?php
if (isset($_REQUEST['active_id'])){
    $id = $_REQUEST['active_id'];
    $active = $cat->activeBrandById($id);
}
?>
...
if (isset($_REQUEST['in_ctive_id'])){
    ...
    $inactive = $cat->inActiveBrandById($id);
}
?>
                                        ...
                                        while ($result = $getCat->fetch_assoc()) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="editCategory.php?catId=<?= $result['id']; ?>" class="btn btn-info btn-sm">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="?catId=<?= $result['id']?>" class="btn btn-outline-dark">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
