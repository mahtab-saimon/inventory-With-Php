...
if (isset($_REQUEST['empId'])){
    $id = $_REQUEST['empId'];
    $delEmployee = $emp->delEmployeeById($id);
}
?>
                                        ...
                                        while ($result = $getEmployee->fetch_assoc()) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="editEmployee.php?empId=<?= $result['id']; ?>" class="btn btn-info btn-sm"> <i class="fa fa-edit"></i></a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="?empId=<?= $result['id']?>" class="btn btn-outline-dark">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
