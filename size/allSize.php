...
?>
<?php
if (isset($_REQUEST['szId'])){
    $id = $_REQUEST['szId'];
    $delSize = $sz->delSizeById($id);
}
?>
<?php
if (isset($_REQUEST['active_id'])){
    $id = $_REQUEST['active_id'];
    $active = $sz->activeBrandById($id);
}
?>
...
if (isset($_REQUEST['in_ctive_id'])){
    ...
    $inactive = $sz->inActiveBrandById($id);
}
?>
...
<head>
    ...
    <title>Inventory  | All Brand</title>
                                        ...
                                        while ($result = $getSize->fetch_assoc()) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="editBrand.php?szId=<?= $result['id']; ?>" class="btn btn-info btn-sm">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="?szId=<?= $result['id']?>" class="btn btn-outline-dark">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
