...
if (isset($_REQUEST['in_ctive_id'])){
    ...
    $status=$_POST['status'];
    $inactive = $br->inActiveBrandById($id);
}
?>
                                        ...
                                        while ($result = $getBrand->fetch_assoc()) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="editBrand.php?brId=<?= $result['id']; ?>" class="btn btn-info btn-sm">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="?brId=<?= $result['id']?>" class="btn btn-outline-dark">Delete</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
